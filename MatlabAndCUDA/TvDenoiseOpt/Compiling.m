...
disp('2. C/C++ compiling for TvDenoiseCuda.cpp with AddVectors.obj...');

% -lcudart 表明使用了CUDA运行时库
% -lcublas 表明使用了CUDABLAS库
% -L"..." 使用的库的库文件路径
% -L"..." 使用的库的头文件路径
mex TvDenoiseCuda.cpp TvDenoise.obj -lcudart -L"C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v5.5\lib\x64"

disp('C/C++ compiling done!');

disp('3.Test TvDenoiseCuda()...');
